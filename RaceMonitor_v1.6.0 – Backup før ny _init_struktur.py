...
class ControlPanel(QObject):
    ...
    def __init__(self, db_thread, config_manager, racemonitorapp, race_app=None):
        ...
        #self.race_app.get_request_for_sim_signal.connect(self.process_sim_signal) # Connect the signal to a slot that processes the sim data
...
class RaceMonitorApp(QMainWindow): #Soon to be rename GuiMainApp
    ...
    def __init__(self):
        ...
        # 3. Etterpå: Koble signalet nå som begge objektene eksisterer
...
class RaceApp(QThread):
    ...
    def update_ip_address(self, ip_address):
        ...
        self.driver_view_first_update = True  # Reset the flag to ensure the driver view is updated with the new IP address  
