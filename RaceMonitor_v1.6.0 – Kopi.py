...
class MonitorThread(QThread):
    ...
    def calculate_session_id_for_participants(self, current_participants, ip_name_flag):
        """
    ...
    async def race_running(self, data):
        ...
        # Calculate session ID directly in MonitorThread (no more DB task queue)
        calculated_session_id = self.calculate_session_id_for_participants(participants, self.ip_name_flag)
        
        # Update session ID with automatic assignment
