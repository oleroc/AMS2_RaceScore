...
class RaceMonitorApp(QMainWindow):
            ...
            for i, participant in enumerate(sorted_participants):
                ...
                if current_lap < 3:
                    ...
                    if valid_lap_times:
                        ...
                        if participant['mFastestLapTimes'] == best_lap_time and self.current_bestlap_name != participant_name:
                            background_color = "#A7DB8D"  # Green background for the best lap
                            print(f"Best time color assigned: {participant_name} Time: {best_lap_time}")
                            self.current_bestlap_name = participant_name
                        else:
                            background_color = "#333333"  # Default background color
                    else:
    ...
    def create_participant_text(participant, last_lap_str, fastest_lap_str, lap_times_str=""):
