...
class RaceMonitorApp(QMainWindow):
    ...
    def show_error_message(self, message): # Check if the error label already exists with the same message
        ...
        self.error_label.setFixedSize(1060, 45)
    ...
    def create_participant_text(self, participant,flag, last_lap_str, lap_times_str, total_time_str=""): # Helper function to create participant text with custom styling.self.initialize_dropdown
        ...
        if participant['mPitModes'] == 2:
            ...
            #pit_stops = f" <span style='color:#00fff0'>{'Pits: </span><span style='color:#FFD700'>sum(self.pit_stops[participant['mName']].values()) if sum(self.pit_stops[participant['mName']].values()) > 0 else '0'} </span>"
            ...
            #print(f"RMA Pit Stop: {self.pit_stops}")
