...
class MonitorThread(QThread):
    ...
    connection_restored = pyqtSignal()  # Signal with for removing the error message
    ...
    def run(self):
        while self.running:
            try:
                ...
                self.connection_restored.emit() # Emit signal for successful connection restoration to remove the error message
