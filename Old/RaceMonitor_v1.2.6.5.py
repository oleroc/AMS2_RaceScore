        ...
        while self.running:
            try:
                ...
                if operation == 'write_race':
                    ...
                    #print("Calling Fetchrecorded laps")
...
class RaceMonitorApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.db_thread.race_data_loaded_signal.connect(self.load_selected_race)  # Connect the signal to the slot that updates the UI
    ...
    def load_selected_race(self):
        ...
        if selected_index >= 0:
            ...
            # Old direct database interaction code is commented out
            # conn = sqlite3.connect('RaceDB.db')
            # cursor = conn.cursor()

            # Function to be called when the data is loaded
            def on_race_loaded(race_id, track_variation, laps_in_event, participants):
                if race_id:
            ...
            self.db_queue.put(('load_selected_race', (race_index, on_race_loaded)))

            # conn.close()  # Comment this line
