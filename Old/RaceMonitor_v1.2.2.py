...
class RaceMonitorApp(QMainWindow):
    def __init__(self):
        ...
        self.tab_widget_mapping = {
            0: ['live_heading'],  # Widgets for Live View
            1: ['results','results_heading', 'dropdown', 'delete_button'],  # Widgets for Results View
            2: ['final_results', 'final_heading' ],  # Widgets for Final View
        }
        '''
        ...
        self.final_view_layout = QVBoxLayout(self.results_view_widget)
    ...
    def setup_live_view(self):
        ...
        self.live_heading = QLabel("", self.live_view_widget)
        self.live_heading.setStyleSheet("font-size: 16px;font-weight:bold; color: black;")
        self.live_view_layout.addWidget(self.live_heading)
        self.live_heading.setMinimumSize(200, 50)  # Set this to a size that you believe should fit your text
        self.live_heading.setStyleSheet("font-size: 16px;font-weight:bold; color: black; border: 1px solid red;")
    ...
    def setup_result_view(self):
        ...
        # Heading label for results view
        ...
        self.results_content = QLabel("", self.results_view_widget)
        self.results_content.setStyleSheet("font-size: 14px; color: black;")
        self.results_view_layout.addWidget(self.results_content)

    def setup_final_view(self):
        # Setup your final view widgets here

        # Heading label for final view
        self.final_heading = QLabel("", self.final_view_widget)
        self.final_heading.setStyleSheet("font-size: 16px; color: black;")
        self.final_view_layout.addWidget(self.final_heading)

        # Content label for displaying Final results
        self.final_content = QLabel("", self.final_view_widget)
        self.final_content.setStyleSheet("font-size: 14px; color: black;")
    ...
    def load_race_data_on_start(self):
        ...
        if races:
            ...
            self.labels['live_heading'].setText("No race data available")
            self.labels['final_results'].setText("Waiting for a new race to start...")
    ...
    def load_selected_race(self):
        ...
        if selected_index >= 0:
            ...
            if race:
                ...
                loaded_results = "Loaded Standings:\n"
                ...
                for participant in participants:
                    ...
                    loaded_results += (f"{race_position}: {name} - Fastest Lap: {fastest_lap_str} - Lap Times: [{lap_times_str}]\n")
