        ...
        while self.running:
            try:
                ...
                if operation == 'write_race':
                    ...
                    print("DB Update Race Index")
                    self.update_race_index(*args)
                    print ("DB Update Race Index succeeded")
    ...
    def load_selected_race(self, race_index, callback = None):
        ...
        try:
            ...
            if race:
                ...
                self.race_data_loaded_signal.emit(race_id, track_variation, laps_in_event, participants)
...
class MonitorThread(QThread):
    ...
    def __init__(self, tab_widget ,db_queue, *args, **kwargs):
        ...
        self.db_queue.put(('update_race_index', (self.set_race_count,)))
...
class RaceMonitorApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.db_thread.load_race_on_start_signal.connect(self.handle_race_data)       
        ...
        self.tab_widget_mapping = {
            ...
            1: ['dropdown', 'delete_button', 'new_session_button'],  # Widgets for Results View
        ...
        self.new_session_button = QPushButton("start_new_session", self)
        ...
        # self.switch_tab_signal.connect(self.tab_widget.setCurrentIndex)       
    ...
    def load_selected_race(self):
        ...
        if selected_index >= 0:
            ...
            # Queue the operation to DatabaseThread
            #if self.first_time_run:
            self.db_queue.put(('load_selected_race', (race_index,) ))
            print(f"Signal Sent")
            #self.first_time_run = False
            
    def on_race_loaded(self, race_id, track_variation, laps_in_event, participants):
        print(f"Signal received")
        if race_id:
            self.viewing_race_id = race_id  # Set the viewing_race_id with the loaded race_id
            # Original logic for updating the UI
            ...
            for participant in participants:
                ...
                loaded_results += (f"<span style='font-weight:normal;'>{race_position}: {name} - "
                                    f"Fastest Lap: {fastest_lap_str}</span><br>")
