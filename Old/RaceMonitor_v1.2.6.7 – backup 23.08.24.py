            ...
            try:
                ...
                if participants:
                    ...
                    for participant in participants:
                        ...
                        print(f"Participant: {participant['mName']}, Race Position: {participant.get('mRacePosition', 0)}, Total Laps: {total_laps}")
...
class RaceMonitorApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setFixedSize(1080, 800) # Set fixed size to prevent autoresizing
    ...
    def load_sessionid_on_start(self):
         self.db_queue.put(('load_sessionid_on_start',())) #print(f"load race on start Thread ID in operation: {threading.get_ident()}")
