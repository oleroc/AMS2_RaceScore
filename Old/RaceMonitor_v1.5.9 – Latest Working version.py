...
class RaceMonitorApp(QMainWindow):
    ...
    def update_driver_view(self, data):
        ...
        def update_driver_current_lap_time(data):
            driverindex = data['participants']['mViewedParticipantIndex'] # Get the index of the viewed participant
            ...
            #print(f"RMA Line {inspect.currentframe().f_lineno} Driver current lap: {lap}, sector index: {sector_index}, s1: {s1}, s2: {s2}, s3: {s3}")
            ...
            if s1 == -1 and s3 != -1: #Race is over 
                current_lap_time = driver['mLastLapTimes']   # Set to last completed lap time
        ...
        self.laptime_text.setText(self.format_lap_time(update_driver_current_lap_time(data))) 
