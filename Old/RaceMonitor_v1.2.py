    ...
    def load_selected_race(self):
        ...
        if selected_index >= 0:
            ...
            if race:
                ...
                self.current_race_id = race_id
                logging.info(f"Load Selected Race, RaceID: {self.current_race_id}")
                print(f"Load Selected Race, RaceID: {self.current_race_id}")
                cursor.execute('''
                ...
                #self.results_content.setText(final_results)
    ...
    def delete_selected_race(self):
        ...
        if selected_index >= 0:
            ...
            if race:
                ...
                if self.current_race_id == race_id:
