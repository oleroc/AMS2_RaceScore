...
class GuiMainApp(QMainWindow):
    ...
    def initUI(self):
        ...
        for i, ip in enumerate(self.available_ips):
            ...
            """)
            btn.setFixedSize(150, 30)  # Sett en fast størrelse for knappene
...
class RaceApp(QThread):
    ...
    def on_first_live_view_run(self, data):
        ...
        self.get_pariticipants_ips(participants)  # Get the participants IPs and update the driver view 
